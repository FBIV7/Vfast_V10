        ...
        <div className="blogs__wraper   py-20 px-20">
          <div className=" block justify-between items-center md:flex justify-between items-center">
            <div className="blogs bg-white mr-5">
              ...
              <div className="p-5">
                <h1 className="text-2xl font-bold font-serif text-black-800 py-2">
                  Amarjeet Singh
                </h1>
                <p className="bg-white font-mono text-sm text-black">Managing Director</p>
              </div>
            </div>
            ...
            <div className="blogs bg-white mr-5">
              ...
              <div className="p-5">
                ...
                <p className="bg-white font-mono text-sm text-black">Operations</p>
              </div>
            </div>
            ...
            <div className="blogs bg-white mr-5">
              ...
              <div className="p-5">
                ...
                <p className="bg-white font-mono text-sm text-black">Developer</p>
              </div>
            </div>
            <div className="blogs bg-white mr-5">
              ...
              <div className="p-5">
                ...
                <p className="bg-white font-mono text-sm text-black">HR Executive</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className=" block justify-center sm:flex md:m-20">
        ...
        <div className="border-r border-b border-l border-grey-light lg:border-l-0 lg:border-t lg:border-grey-light bg-white rounded-b lg:rounded-b-none lg:rounded-r p-4 flex flex-col justify-between leading-normal">
          <div className="mb-8">
            ...
            <p className="text-grey-darker font-sans text-base border-l-4 border-gray-500 pl-4 mb-6 italic rounded">
