  ...
  return (
    <div className="contactStyle ">
      <div className="flex justify-center text-3xl section-title font-serif md:text-5xl">
        <div
          className="font flex justify-center "
      ...
      <div className="block justify-center item">
        ...
        <div className="h-0 my-2 border border-solid border-t-0 border-white-900 opacity-25 w-1/2 mx-auto" />
        <p className="flex justify-center mx-auto text-sm md:text-4xl">
          Copyright &copy; 2020 All Rights Reserved @ VFAST
        </p>
      </div>
    </div>
  );
