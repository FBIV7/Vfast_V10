    ...
    <div className="text-center styleService">
      ...
      <div className="verification md:grid grid-cols-3 gap-4 m-4">
        <div className="styleImg text-center md:col-span-1">
          ...
          <h3 className="text-white font-serif">Employee Verifcation</h3>
          <p className=" font-sans">
        ...
        <div className="styleImg text-center block md:col-span-1">
          ...
          <h3 className="text-white font-serif">Company Verification</h3>
          <p className=" font-sans">
        ...
        <div className="styleImg text-center block md:col-span-1">
          ...
          <h3 className="text-white font-serif">Tenant Verification</h3>
          <p className=" font-sans">
        ...
        <div className="styleImg text-center block">
          ...
          <h3 className="text-white font-serif">Vehicle Verfication</h3>
          <p className=" font-sans">
        ...
        <div className="styleImg text-center block">
          <i className="fa fa-inbox fa-5x  circle"></i>
          <h3 className="text-white font-serif">Property Verification</h3>
          <p className=" font-sans">
        ...
        >
          ...
          <h3 className="text-white font-serif">Bride/Groom Verification</h3>
          <p className=" font-sans">
